...
RSpec.describe ProjectsController, type: :controller do
  ...
  describe 'GET #hiwi_working_hours' do
    it 'returns the sum of all hiwi working hours as JSON' do
      ...
      contract1 = FactoryBot.create(:contract, hiwi: user1)
      user2 = FactoryBot.create(:user)
      contract2 = FactoryBot.create(:contract, hiwi: user2)
      project.users << user1
      project.users << user2
      time_sheet1 = FactoryBot.create(:time_sheet, contract: contract1)
      time_sheet2 = FactoryBot.create(:time_sheet, contract: contract2)
  ...
  describe 'POST #add_user_from_email' do
    before :each do
      @project = FactoryBot.create(:project, chair: @user.chair)
      @project.users << @user
    end
