...
RSpec.describe Project, type: :model do
  ...
  it 'returns correct data for ChartJS' do
    ...
    expect(Project.workdays_data(2015, 11)).to eq("{ y: 0, name: \"Factory Project\"},\n{ y: 8.5, name: \"Working Hours Project\"}")
    expect(Project.workdays_data(2015, 12)).to eq("{ y: 0, name: \"Factory Project\"},\n{ y: 8.0, name: \"Working Hours Project\"}")
  end
end
